    ...
    <div class="col-md-6">
        <div class="detail-card">
            ...
            <div class="detail-card-body">
                <form method="POST" action="{{ route('waspang.store') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label-soft">Nama Lengkap <span class="text-danger">*</span></label>
                            <input type="text" name="nama" class="form-control-soft" required value="{{ old('nama') }}">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label-soft">NIK <span class="text-danger">*</span></label>
                            <input type="text" name="nik" class="form-control-soft" required value="{{ old('nik') }}">
                        </div>
                        <div class="col-md-12">
                            <label class="form-label-soft">Jabatan</label>
                            <input type="text" name="jabatan" class="form-control-soft" value="{{ old('jabatan') }}">
                        </div>
                    </div>
